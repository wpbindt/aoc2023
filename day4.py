...
card_header = right(right(word('Card '), nonnegative_integer), word(': '))
numbers = apply(set, separated_by_(nonnegative_integer, many_plus(word(' '))))
...
assert nonnegative_integer('13').result == 13
